...
function Declerations({userData}) {
  return (
    ...
    <div className="row-span-2 bg-blue-100 rounded p-5">  {userData.id? <img src={userData.avatar_url} alt="avatar" className='rounded-full h-40 m-auto' /> : <a href="/cross.png"></a> }</div>
