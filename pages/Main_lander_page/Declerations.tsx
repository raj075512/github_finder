...
function Declerations({userData}) {
  return (
    <div className='grid grid-cols-1 gap-4 justify-between m-12  font-medium  relative rounded-md '>

        
        <div className="p-5 bg-blue-200 text-blue-800 grid grid-cols-3 grid-rows-3 rounded-md gap-3">
    ...
    <div className="bg-blue-100 rounded p-5 font-medium text-red-500">Public_gists: {userData.public_gists}
    <span className='flex center '>Repos: {userData.public_repos} </span></div>
    <div className="row-span-2 bg-blue-100 rounded p-6">
